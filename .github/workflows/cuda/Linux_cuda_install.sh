...
elif [[ $CUDA_VERSION == @(cu111|cu112|cu113) ]]; then
  distro=ubuntu2004
  sudo apt install --no-install-recommends gcc-10 g++-10
  sudo update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-10 100 --slave /usr/bin/g++ g++ /usr/bin/g++-10 --slave /usr/bin/gcov gcov /usr/bin/gcov-10
elif [[ $CUDA_VERSION == @(cu114|cu115|cu116) ]]; then
  distro=ubuntu2004
  sudo apt install --no-install-recommends gcc-11 g++-11
  sudo update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-11 110 --slave /usr/bin/g++ g++ /usr/bin/g++-11 --slave /usr/bin/gcov gcov /usr/bin/gcov-11
elif [[ $CUDA_VERSION == @(cu117|cu118) ]]; then
  distro=ubuntu2204
  sudo apt install --no-install-recommends gcc-11 g++-11
  sudo update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-11 110 --slave /usr/bin/g++ g++ /usr/bin/g++-11 --slave /usr/bin/gcov gcov /usr/bin/gcov-11
elif [[ $CUDA_VERSION == @(cu120|cu121|cu122|cu123) ]]; then
  distro=ubuntu2204
